...
import net.mcreator.trollmod.block.NukedimPortalBlock;
...
public class TrollmodModBlocks {
	...
	public static final RegistryObject<Block> NUKEDIM_PORTAL = REGISTRY.register("nukedim_portal", () -> new NukedimPortalBlock());
}
