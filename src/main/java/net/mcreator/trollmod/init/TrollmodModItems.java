...
public class TrollmodModItems {
	...
	public static final RegistryObject<Item> BOOMMOND = block(TrollmodModBlocks.BOOMMOND, TrollmodModTabs.TAB_MTNTIB);
	public static final RegistryObject<Item> NUKE = block(TrollmodModBlocks.NUKE, TrollmodModTabs.TAB_MTNTIB);
	...
	public static final RegistryObject<Item> CITYBOMB = block(TrollmodModBlocks.CITYBOMB, TrollmodModTabs.TAB_MTNTIB);
	public static final RegistryObject<Item> URANITEM = REGISTRY.register("uranitem", () -> new UranitemItem());
	public static final RegistryObject<Item> URAN = block(TrollmodModBlocks.URAN, TrollmodModTabs.TAB_MTNTIB);
